**안녕하세요! 사용자 흐름과 실사용성을 고민하며 성장하는 웹 개발자 유희연입니다. 👋**

## About Me

- **정보통신 전공**을 기반으로 네트워크 및 시스템 기초 지식을 쌓았습니다.
- **풀스택 교육과정**을 통해 서비스 기획부터 배포까지 전 과정을 경험하며 실무 능력을 길렀습니다.
- **기술적 성장과 사용자 경험**을 동시에 고민하며, 팀의 목표를 기술로 멋지게 실현하고 싶습니다.
